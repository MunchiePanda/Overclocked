...
public class TerminalControllerUpdated : MonoBehaviour
{
    ...
    void HandleCipherPuzzleRequest()
    {
        if (cipherPuzzle != null)
        {
            // Add special cipher-specific hints if puzzle is active
    ...
    void HandleColorLightPuzzleRequest()
    {
        if (colorLightPuzzle != null)
        {
            // Add special color light hints if puzzle is active
