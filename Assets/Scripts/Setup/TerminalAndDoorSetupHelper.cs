...
/// </summary>
public class TerminalAndDoorSetupHelper : MonoBehaviour
{
    ...
    bool SetupAITerminal()
    {
        try
        {
            ...
            if (replaceTerminalController)
            {
                ...
                TerminalControllerUpdated newController = terminalObject.GetComponent<TerminalControllerUpdated>();
                ...
                if (oldController != null && newController == null)
                {
                    ...
                    // Add new controller
                    newController = terminalObject.AddComponent<TerminalControllerUpdated>();
                    ...
                    if (showDetailedLogs)
                        Debug.Log("✅ Replaced old TerminalControllerNew with TerminalControllerUpdated");
                }
                else if (newController == null)
                {
                    ...
                    newController = terminalObject.AddComponent<TerminalControllerUpdated>();
                    if (showDetailedLogs)
                        Debug.Log("✅ Added new TerminalControllerUpdated");
                }
            }
            
            // Verify puzzle references
            TerminalControllerUpdated controller = terminalObject.GetComponent<TerminalControllerUpdated>();
            if (controller != null)
            {
    ...
    public void ShowSystemStatus()
    {
        ...
        bool allGood = terminalObject != null && doorObject != null &&
                      terminalObject.GetComponent<TerminalControllerUpdated>() != null &&
